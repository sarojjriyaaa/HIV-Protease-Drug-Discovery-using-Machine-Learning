...
- Optimize docking using Reinforcement Learning.
- Generate molecular descriptors using RDKit.
- Predict drug-likeness and ADMET properties.
- Develop machine learning models for inhibitor prediction.
- Prioritize lead compounds for further validation.
...
- Literature Review
- Dataset Collection (ChEMBL, PubChem)
- Protein Preparation
- Ligand Preparation
- Molecular Docking
